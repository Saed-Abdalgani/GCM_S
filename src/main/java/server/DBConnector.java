...
public class DBConnector {
    ...
    private static final String URL = "jdbc:mysql://localhost/gcm_db?serverTimezone=Asia/Jerusalem";
    private static final String USER = "root";
    private static final String PASS = "momo8523"; // <--- Put your MySQL password here
